...
let array = [{id: 3, parent: 2}, {id: 1, parent: null}, {id: 2, parent: 1}, {id: 5, parent: 3}]
...
解释：catch 形成的块级作用域有点特殊，只对 catch 中的参数执行此特性，例如上例中的 x 和 y，x 的变量提升不到函数的作用域中，所以出现 undefined，而 y 由于不是 catch 的参数，所以可以提升到函数作用域。
